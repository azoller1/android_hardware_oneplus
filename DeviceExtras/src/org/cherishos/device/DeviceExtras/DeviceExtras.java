...
* Copyright (C) 2021 The cherishos X Project
...
*
*/
package org.cherishos.device.DeviceExtras;
...
import org.cherishos.device.DeviceExtras.Constants;
import org.cherishos.device.DeviceExtras.doze.DozeSettingsActivity;
import org.cherishos.device.DeviceExtras.kcal.KCalSettingsActivity;
import org.cherishos.device.DeviceExtras.FileUtils;
import org.cherishos.device.DeviceExtras.R;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.cherishos.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
